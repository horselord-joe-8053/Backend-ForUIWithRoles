...
function initResidents() {
  var residentDataArr = initData['resident_data'];
  logger.logAsJsonStr('server.js initResidents', 'residentDataArr', residentDataArr);

  residentDataArr.forEach((data, index) =>
