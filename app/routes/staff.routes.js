...
module.exports = function (app) {
  ...
  app.post(
    ...
    controller.staffCreate // jjw: here??? TODO: we can remove staff.controller entirely
  );

  app.put(
    '/api/test/staff/:id',
    [authJwt.verifyAccToken, authJwt.verifyIsAtLeastOwner],
    controller.staffUpdate // jjw: here??? TODO: we can remove staff.controller entirely, just using item.controller??
  );
